...
;; ## added by OPAM user-setup for emacs / ocp-indent ## a193fc54ff5c4dcff76ac4ea3ceeee40 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/autumn/.opam/4.09.0/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/autumn/.opam/4.09.0/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/autumn/.opam/4.09.0/bin/ocp-indent"))
;; ## end of OPAM user-setup addition for emacs / ocp-indent ## keep this line
;; ## added by OPAM user-setup for emacs / tuareg ## 24082b15311c4fd843a4018e7be69bbb ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/autumn/.opam/4.09.0/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
